...
from deep_dialog.usersims import RuleSimulator, AlternateSimulator
...
if usr == 0:# real user
    ...
    user_sim = AlternateSimulator(movie_dictionary, act_set, slot_set, goal_set, usersim_params)
